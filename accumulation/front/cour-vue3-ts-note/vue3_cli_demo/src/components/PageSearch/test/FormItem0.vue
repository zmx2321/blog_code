  ...
  <div class='form-item'>
    <el-input v-if="isInput"
      ...
      <i v-if="isShowIcon"
         ...
         @click="() => {itemOptions.iconClick&&itemOptions.iconClick(currentVal)}">
      </i>
    </el-input>
    ...
    <el-autocomplete v-if="isAutocomplete"
                     v-model="currentVal"
                     v-bind="bindProps"
                     v-on="bindEvents"></el-autocomplete>

    <el-select v-if="isSelectAndSearch"
               filterable
               remote
               reserve-keyword
               v-model="currentVal"
    ...
    <el-date-picker v-if="isDatePickerDateRange"
                    ...
                    :value-format="itemOptions.valueFormat">
    </el-date-picker>
