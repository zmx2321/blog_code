...
function updateProps(instance, rawProps, rawPrevProps, optimized) {
  ...
  /* FULL_PROPS */
    ...
    for (var _key3 in rawCurrentProps) {
      ...
      !(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasOwn)(rawProps, _key3) && ( // it's possible the original props was passed in as kebab-case
      // and converted to camelCase (#955)
      (kebabKey = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.hyphenate)(_key3)) === _key3 || !(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasOwn)(rawProps, kebabKey))) {
        if (options) {
    ...
    if (attrs !== rawCurrentProps) {
      for (var _key4 in attrs) {
        if (!rawProps || !(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasOwn)(rawProps, _key4)) {
          delete attrs[_key4];
        }
      }
    }
...
function doWatch(source, cb) {
  ...
  var oldValue = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(source) ? [] : INITIAL_WATCHER_VALUE;
...
function instanceWatch(source, cb, options) {
  ...
  var getter = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isString)(source) ? function () {
...
var setRef = function setRef(rawRef, oldRawRef, parentSuspense, vnode) {
  if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(rawRef)) {
    rawRef.forEach(function (r, i) {
      return setRef(r, oldRawRef && ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(oldRawRef) ? oldRawRef[i] : oldRawRef), parentSuspense, vnode);
    });
    return;
  }
    ...
    if (oldProps !== newProps) {
      ...
      if (oldProps !== _vue_shared__WEBPACK_IMPORTED_MODULE_1__.EMPTY_OBJ) {
        for (var _key9 in oldProps) {
          if (!(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isReservedProp)(_key9) && !(_key9 in newProps)) {
...
function applyOptions(instance, options) {
  ...
  if (!asMixin) {
    ...
    if (true) {
      (function () {
        var rawData = (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.toRaw)(instance.data);
